...
export const translations: Translations = {
  ...
  'industries.description': { es: 'Ejemplos reales de chatbots (WhatsApp y web) y voice bots (recepción telefónica) por industria.', en: 'Real examples of chatbots (WhatsApp and web) and voice bots (phone reception) by industry.' },
  ...
  'industries.realestate.b1': { es: 'Chat: responde por WhatsApp y web sobre cada propiedad', en: 'Chat: answers on WhatsApp and web about every listing' },
  'industries.realestate.b2': { es: 'Voz: contesta llamadas y pre-califica al comprador', en: 'Voice: answers calls and pre-qualifies the buyer' },
  'industries.realestate.b3': { es: 'Agenda visitas en tu calendario desde chat o llamada', en: 'Books visits to your calendar from chat or call' },
  ...
  'industries.restaurants.b1': { es: 'Chat: confirma reservas al instante por WhatsApp', en: 'Chat: confirms reservations instantly on WhatsApp' },
  'industries.restaurants.b2': { es: 'Voz: contesta el teléfono en hora pico y toma la reserva', en: 'Voice: answers the phone at rush hour and takes the booking' },
  'industries.restaurants.b3': { es: 'Envía menú y promos del día automáticamente', en: 'Sends menu and daily specials automatically' },
  ...
  'industries.clinics.b1': { es: 'Chat: agenda, reagenda y cancela citas por WhatsApp', en: 'Chat: books, reschedules and cancels appointments on WhatsApp' },
  'industries.clinics.b2': { es: 'Voz: recepcionista IA 24/7 que nunca deja el teléfono sonando', en: 'Voice: 24/7 AI receptionist so the phone is never left ringing' },
  'industries.clinics.b3': { es: 'Responde sobre tratamientos y precios y envía recordatorios', en: 'Answers about treatments and pricing and sends reminders' },
  ...
  'industries.gyms.b1': { es: 'Chat: informa planes y horarios al instante', en: 'Chat: shares plans and schedules instantly' },
  'industries.gyms.b2': { es: 'Voz: atiende llamadas y agenda la clase de prueba', en: 'Voice: answers calls and books the trial class' },
  'industries.gyms.b3': { es: 'Cierra inscripciones y reserva servicios sin intervención', en: 'Closes sign-ups and books services hands-free' },
  ...
  'products.suite.desc': { es: 'Chatbot + Voice Bot en un solo sistema.', en: 'Chatbot + Voice Bot in one system.' },
