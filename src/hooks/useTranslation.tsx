...
export const translations: Translations = {
  ...
  // Hero
  "hero.badge": {
    es: "IA que trabaja junto a tu equipo · 24/7",
    en: "AI that works with your team · 24/7",
  },
  ...
  "problem.titleAccent": {
    es: "tareas que no requieren criterio.",
    en: "tasks that don't need judgment.",
  },
  "problem.subtitle": {
  ...
  "problem.p1.desc": {
    es: "Horarios, precios y FAQs consumen el día de tu equipo.",
    en: "Hours, pricing and FAQs eat your team's day.",
  },
  "problem.p2.title": { es: "Clientes fuera de horario", en: "After-hours customers" },
  "problem.p2.desc": {
    es: "Cuando la oficina cierra, las consultas no esperan.",
    en: "When the office closes, inquiries don't wait.",
  },
  "problem.p3.title": { es: "Menos tiempo para lo importante", en: "Less time for what matters" },
  "problem.p3.desc": {
    es: "Agenda manual y errores restan atención a clientes VIP.",
    en: "Manual booking and errors steal focus from VIP clients.",
  },
  ...
  "assistant.b1": {
    es: "Respuestas inmediatas en WhatsApp y Web Chat",
    en: "Instant replies on WhatsApp and Web Chat",
  },
  "assistant.b2": {
    es: "FAQ: precios, horarios, citas y stock",
    en: "FAQs: pricing, hours, appointments and stock",
  },
  "assistant.b3": {
    es: "Captura de leads 24/7 para tu equipo",
    en: "24/7 lead capture for your team",
  },
  ...
  "propia.step1.desc": {
    es: "Una sola vez, desde tu celular o computadora.",
    en: "Just once, from your phone or computer.",
  },
  "propia.step2.title": { es: "IA genera textos SEO", en: "AI generates SEO copy" },
  "propia.step2.desc": {
    es: "Optimizados para alcance y conversión.",
    en: "Optimized for reach and conversion.",
  },
  "propia.step3.title": { es: "IA crea videos automáticos", en: "AI creates videos automatically" },
  "propia.step3.desc": {
    es: "Reels, stories y videos cortos listos para publicar.",
    en: "Reels, stories and short videos ready to publish.",
  },
  "propia.step4.title": { es: "Publica en todas tus redes", en: "Posts to all your channels" },
  "propia.step4.desc": {
    es: "IG (Feed/Stories/Reels), Facebook y TikTok a la vez.",
    en: "IG (Feed/Stories/Reels), Facebook and TikTok at once.",
  },
  "propia.feature1": {
    es: "SEO Enhancer para visibilidad máxima",
    en: "SEO Enhancer for maximum visibility",
  },
  "propia.feature2": {
    es: "Notificaciones por WhatsApp en cada publicación",
    en: "WhatsApp notifications on every post",
  },
  ...
  "industries.description": {
    es: "Ejemplos reales de chatbots (WhatsApp y web) y voice bots (recepción telefónica) por industria.",
    en: "Real examples of chatbots (WhatsApp and web) and voice bots (phone reception) by industry.",
  },
  "industries.realestate.tab": { es: "Inmobiliarias", en: "Real Estate" },
  "industries.realestate.title": {
    es: "Califica leads y agenda visitas mientras muestras propiedades.",
    en: "Qualify leads and book visits while you show properties.",
  },
  "industries.realestate.b1": {
    es: "Chat: responde por WhatsApp y web sobre cada propiedad",
    en: "Chat: answers on WhatsApp and web about every listing",
  },
  "industries.realestate.b2": {
    es: "Voz: contesta llamadas y pre-califica al comprador",
    en: "Voice: answers calls and pre-qualifies the buyer",
  },
  "industries.realestate.b3": {
    es: "Agenda visitas en tu calendario desde chat o llamada",
    en: "Books visits to your calendar from chat or call",
  },
  "industries.restaurants.tab": { es: "Restaurantes", en: "Restaurants" },
  "industries.restaurants.title": {
    es: "Reservas y pedidos automáticos sin errores.",
    en: "Automatic bookings and orders, error-free.",
  },
  "industries.restaurants.b1": {
    es: "Chat: confirma reservas al instante por WhatsApp",
    en: "Chat: confirms reservations instantly on WhatsApp",
  },
  "industries.restaurants.b2": {
    es: "Voz: contesta el teléfono en hora pico y toma la reserva",
    en: "Voice: answers the phone at rush hour and takes the booking",
  },
  "industries.restaurants.b3": {
    es: "Envía menú y promos del día automáticamente",
    en: "Sends menu and daily specials automatically",
  },
  "industries.clinics.tab": { es: "Clínicas", en: "Clinics" },
  "industries.clinics.title": {
    es: "Gestión de citas y consultas frecuentes 24/7.",
    en: "Appointment management and FAQs 24/7.",
  },
  "industries.clinics.b1": {
    es: "Chat: agenda, reagenda y cancela citas por WhatsApp",
    en: "Chat: books, reschedules and cancels appointments on WhatsApp",
  },
  "industries.clinics.b2": {
    es: "Voz: recepcionista IA 24/7 que nunca deja el teléfono sonando",
    en: "Voice: 24/7 AI receptionist so the phone is never left ringing",
  },
  "industries.clinics.b3": {
    es: "Responde sobre tratamientos y precios y envía recordatorios",
    en: "Answers about treatments and pricing and sends reminders",
  },
  "industries.gyms.tab": { es: "Gimnasios y Salones", en: "Gyms & Salons" },
  "industries.gyms.title": {
    es: "Convierte consultas en suscripciones al instante.",
    en: "Turn inquiries into subscriptions instantly.",
  },
  "industries.gyms.b1": {
    es: "Chat: informa planes y horarios al instante",
    en: "Chat: shares plans and schedules instantly",
  },
  "industries.gyms.b2": {
    es: "Voz: atiende llamadas y agenda la clase de prueba",
    en: "Voice: answers calls and books the trial class",
  },
  "industries.gyms.b3": {
    es: "Cierra inscripciones y reserva servicios sin intervención",
    en: "Closes sign-ups and books services hands-free",
  },

  // Testimonials
  "testimonials.title": { es: "Equipos que ya", en: "Teams already" },
  "testimonials.titleAccent": {
    es: "trabajan con un copiloto IA.",
    en: "working with an AI copilot.",
  },
  ...
  "pricing.starter.desc": {
    es: "Empieza a atender 24/7 en WhatsApp, Telegram y Web Chat.",
    en: "Start serving 24/7 on WhatsApp, Telegram and Web Chat.",
  },
  "pricing.starter.f1": {
    es: "Hasta 800 mensajes WhatsApp/mes",
    en: "Up to 800 WhatsApp messages/mo",
  },
  "pricing.starter.f2": {
    es: "WhatsApp Business + Telegram + Web Chat",
    en: "WhatsApp Business + Telegram + Web Chat",
  },
  ...
  "pricing.basic.desc": {
    es: "Todo Inicio + agenda, cotizaciones y links de pago.",
    en: "Everything in Starter + booking, quotes and payment links.",
  },
  "pricing.basic.f1": {
    es: "Hasta 2,500 mensajes WhatsApp/mes",
    en: "Up to 2,500 WhatsApp messages/mo",
  },
  "pricing.basic.f2": {
    es: "Google Calendar + agenda automática",
    en: "Google Calendar + automatic booking",
  },
  ...
  "pricing.growth.desc": {
    es: "Todo Bronce + Instagram, Facebook, memoria y handoff.",
    en: "Everything in Bronze + Instagram, Facebook, memory and handoff.",
  },
  "pricing.growth.f1": {
    es: "Hasta 6,000 mensajes WhatsApp/mes",
    en: "Up to 6,000 WhatsApp messages/mo",
  },
  ...
  "pricing.propia.desc": {
    es: "Todo Plata + CRM, catálogo y omnicanal completo.",
    en: "Everything in Silver + CRM, catalog and full omnichannel.",
  },
  "pricing.propia.setup": { es: "Setup", en: "Setup" },
  "pricing.propia.f1": {
    es: "Hasta 15,000 mensajes WhatsApp/mes",
    en: "Up to 15,000 WhatsApp messages/mo",
  },
  ...
  "pricing.propia.f5": {
    es: "Omnicanal completo + Reportes y analíticas",
    en: "Full omnichannel + reports & analytics",
  },
  "pricing.propia.f6": { es: "Soporte prioritario", en: "Priority support" },
  "pricing.note": {
    es: "Los mensajes de WhatsApp tienen un costo por mensaje de Meta. Instagram, Facebook Messenger, Telegram y Web Chat son canales sin costo adicional — incluidos según tu plan.",
    en: "WhatsApp messages carry a per-message cost from Meta. Instagram, Facebook Messenger, Telegram and Web Chat have no additional cost — included according to your plan.",
  },
  "pricing.channels.title": { es: "Canales adicionales", en: "Additional channels" },
  "pricing.channels.subtitle": {
    es: "Suma canales a cualquier plan. Precio por canal, mensual.",
    en: "Add channels to any plan. Per-channel monthly price.",
  },
  ...
  // Voice Bot pricing
  "pricing.voice.title": {
    es: "Voice Bots IA — Asistente telefónico",
    en: "AI Voice Bots — Phone assistant",
  },
  "pricing.voice.subtitle": {
    es: "Atiende llamadas repetitivas y agenda; tu equipo interviene cuando hace falta criterio.",
    en: "Handles repetitive calls and booking; your team steps in when judgment is needed.",
  },
  "pricing.voice.bronze.name": { es: "Inicio", en: "Starter" },
  "pricing.voice.bronze.desc": {
    es: "Asistente de voz para no perder llamadas.",
    en: "Voice assistant so you never miss a call.",
  },
  ...
  "pricing.voice.silver.desc": {
    es: "Bilingüe y con transferencia a humano.",
    en: "Bilingual with human handoff.",
  },
  ...
  "pricing.voice.silver.f4": {
    es: "WhatsApp post-llamada + reportes",
    en: "Post-call WhatsApp + reports",
  },
  "pricing.voice.silver.f5": { es: "3 líneas simultáneas", en: "3 concurrent lines" },
  "pricing.voice.gold.name": { es: "Plata", en: "Silver" },
  "pricing.voice.gold.desc": {
    es: "Multiidioma, CRM, pagos por voz y llamadas salientes.",
    en: "Multilingual, CRM, voice payments and outbound calls.",
  },
  ...
  "pricing.voice.gold.f4": {
    es: "Llamadas salientes automáticas + pagos por voz",
    en: "Automatic outbound calls + voice payments",
  },
  ...
  "final.description": {
    es: "Activa QubeSight en 48 horas. Sin contratos largos. Más clientes atendidos, menos carga repetitiva.",
    en: "Go live in 48 hours. No long contracts. More customers served, less repetitive load.",
  },
  ...
  "final.bullet.2": {
    es: "Sin permanencia ni contratos largos",
    en: "No lock-in, no long contracts",
  },
  "final.bullet.3": {
    es: "Soporte humano cuando lo necesites",
    en: "Human support whenever you need it",
  },
  "final.bullet.4": {
    es: "Garantía de 14 días o te devolvemos tu dinero",
    en: "14-day money-back guarantee",
  },
  "final.fineprint": {
    es: "Sin tarjeta para probar el demo. Cancela cuando quieras.",
    en: "No card needed to try the demo. Cancel anytime.",
  },

  // Trust bar
  "trustbar.title": {
    es: "Equipos en sectores reales ya trabajan con QubeSight",
    en: "Real-world teams already work with QubeSight",
  },

  // Guarantees
  "guarantee.setup.title": { es: "Activo en 48h", en: "Live in 48h" },
  "guarantee.setup.desc": {
    es: "Configuración 100% gestionada por nuestro equipo.",
    en: "Setup fully managed by our team.",
  },
  "guarantee.nocontract.title": { es: "Sin permanencia", en: "No lock-in" },
  "guarantee.nocontract.desc": {
    es: "Cancela cuando quieras, sin penalizaciones.",
    en: "Cancel anytime, no penalties.",
  },
  "guarantee.support.title": { es: "Soporte real", en: "Real support" },
  "guarantee.support.desc": {
    es: "Humanos respondiendo en menos de 4 horas.",
    en: "Humans replying in under 4 hours.",
  },
  "guarantee.refund.title": { es: "Garantía 14 días", en: "14-day guarantee" },
  "guarantee.refund.desc": {
    es: "Si no te convence, te devolvemos el 100%.",
    en: "Not happy? Full refund within 14 days.",
  },

  // Urgency banner
  "urgency.text": {
    es: "🚀 Lanzamiento Q4 — quedan {n} cupos de onboarding gestionado este mes",
    en: "🚀 Q4 launch — {n} managed onboarding slots left this month",
  },
  ...
  "problem.cta.lead": {
    es: "No hace falta contratar más personas para cubrir lo repetitivo.",
    en: "You don't need to hire more people to cover the repetitive work.",
  },
  "problem.cta.tail": {
    es: "Necesitas un asistente inteligente que trabaje junto a tu equipo.",
    en: "You need a smart assistant that works alongside your team.",
  },
  ...
  // Voice Bot capacity
  "pricing.voice.bronze.capacity": {
    es: "2,000 minutos (~400 llamadas)",
    en: "2,000 minutes (~400 calls)",
  },
  "pricing.voice.silver.capacity": {
    es: "5,000 minutos (~1,000 llamadas)",
    en: "5,000 minutes (~1,000 calls)",
  },
  "pricing.voice.gold.capacity": { es: "12,000 minutos", en: "12,000 minutes" },
  "pricing.voice.overage": {
    es: "Excedente de minutos entrantes: $0.10 por minuto",
    en: "Inbound minute overage: $0.10 per minute",
  },
  ...
  "propia.step2.desc.v2": {
    es: "Optimizados para SEO y conversión.",
    en: "Optimized for SEO and conversion.",
  },
  "propia.step3.title.v2": { es: "IA genera Reels automáticos", en: "AI generates auto Reels" },
  "propia.step3.desc.v2": {
    es: "Videos cortos listos para publicar.",
    en: "Short videos ready to publish.",
  },
  "propia.step4.title.v2": {
    es: "Publica en IG, FB y TikTok",
    en: "Publishes to IG, FB and TikTok",
  },
  "propia.step4.desc.v2": {
    es: "Todas tus redes al mismo tiempo.",
    en: "All your channels simultaneously.",
  },
  "propia.closer": {
  ...
  "diff.others.3": {
    es: "No están adaptadas al mercado local",
    en: "Not adapted to the local market",
  },
  ...
  "roi.b3": {
    es: "Cero consultas perdidas fuera de horario",
    en: "Zero lost after-hours inquiries",
  },
  ...
  "pricing.voice.inboundFree": {
    es: "Minutos entrantes incluidos en tu plan",
    en: "Inbound minutes included in your plan",
  },
  ...
  "pricing.voice.overage.item": {
    es: "Minutos de llamadas salientes: $0.07 por minuto",
    en: "Outbound call minutes: $0.07 per minute",
  },
  "pricing.voice.overage.note": {
    es: "Los minutos entrantes incluidos dependen del plan contratado. El excedente se cobra únicamente cuando se supera el límite mensual.",
    en: "Inbound minutes included depend on the contracted plan. Overage is charged only when the monthly limit is exceeded.",
  },
  "pricing.addon.badge": {
    es: "Recomendado para aumentar ventas",
    en: "Recommended to boost sales",
  },
  "pricing.addon.name": { es: "Outbound Engine", en: "Outbound Engine" },
  "pricing.addon.desc": {
    es: "Recordatorios y follow-ups automáticos. Minutos salientes: $0.07 por minuto.",
    en: "Automatic reminders and follow-ups. Outbound minutes: $0.07 per minute.",
  },
  ...
  "pricing.compare.title": {
    es: "Equipo solo vs Equipo + QubeSight",
    en: "Team alone vs Team + QubeSight",
  },
  ...
  // AI Suite (Chat + Voice)
  "pricing.suite.title": {
    es: "AI Suite — Chatbot + Voice Bot en un solo sistema",
    en: "AI Suite — Chatbot + Voice Bot in one system",
  },
  "pricing.suite.subtitle": {
    es: "Tu negocio responde por escrito y por teléfono con la misma IA: mismo catálogo, misma agenda, mismo historial de cliente. Si escribe por WhatsApp y luego llama, la conversación continúa sin repetir nada.",
    en: "Your business answers in writing and by phone with the same AI: same catalog, same calendar, same customer history. If they message on WhatsApp and then call, the conversation continues without repeating anything.",
  },
  "pricing.suite.b1.title": {
    es: "Cero llamadas y mensajes perdidos",
    en: "Zero missed calls and messages",
  },
  "pricing.suite.b1.desc": {
    es: "Chat 24/7 y recepción telefónica cubren todos los canales, incluso fuera de horario.",
    en: "Chat 24/7 and phone reception cover every channel, even after hours.",
  },
  "pricing.suite.b2.title": { es: "Una sola agenda y un solo CRM", en: "One calendar, one CRM" },
  "pricing.suite.b2.desc": {
    es: "Las citas de chat y de voz caen en el mismo calendario, sin dobles reservas.",
    en: "Chat and voice bookings land in the same calendar, no double bookings.",
  },
  "pricing.suite.b3.title": {
    es: "Contexto compartido entre canales",
    en: "Shared context across channels",
  },
  "pricing.suite.b3.desc": {
    es: "La IA recuerda al cliente aunque cambie de WhatsApp a llamada telefónica.",
    en: "AI remembers the customer even when they switch from WhatsApp to a phone call.",
  },
  "pricing.suite.b4.title": {
    es: "Más barato que contratar por separado",
    en: "Cheaper than buying separately",
  },
  "pricing.suite.b4.desc": {
    es: "Un solo setup, una sola mensualidad y un solo equipo de soporte.",
    en: "One setup, one monthly fee, one support team.",
  },
  ...
  "pricing.suite.business.desc": {
    es: "Chat Bot + Voice Bot con todo incluido.",
    en: "Chat Bot + Voice Bot with everything included.",
  },
  "pricing.suite.business.f1": {
    es: "WhatsApp + Instagram + Facebook + Telegram + Web Chat",
    en: "WhatsApp + Instagram + Facebook + Telegram + Web Chat",
  },
  "pricing.suite.business.f2": {
    es: "Voice Bot como asistente del equipo",
    en: "Voice Bot as a team assistant",
  },
  "pricing.suite.business.f3": {
    es: "CRM integrado + agenda automática",
    en: "Integrated CRM + auto scheduling",
  },
  "pricing.suite.business.f4": {
    es: "Catálogo interactivo + memoria de conversación",
    en: "Interactive catalog + conversation memory",
  },
  "pricing.suite.business.f5": {
    es: "Multiidioma + handoff a humano",
    en: "Multilingual + human handoff",
  },
  "pricing.suite.business.f6": {
    es: "Reportes, analíticas y soporte prioritario",
    en: "Reports, analytics and priority support",
  },
  "pricing.suite.enterprise.name": { es: "Enterprise", en: "Enterprise" },
  "pricing.suite.enterprise.desc": {
    es: "Para operaciones multi-sucursal con flujos a medida.",
    en: "For multi-branch operations with custom flows.",
  },
  ...
  "pricing.suite.enterprise.f3": {
    es: "Integraciones API a la medida",
  ...
  "pricing.suite.enterprise.f6": {
    es: "Automatizaciones avanzadas + soporte dedicado",
    en: "Advanced automations + dedicated support",
  },

  // Section titles
  "pricing.section.chat": { es: "💬 AI Chat Bots", en: "💬 AI Chat Bots" },
  "pricing.chat.title": {
    es: "Chatbots IA para WhatsApp y Web",
    en: "AI Chatbots for WhatsApp & Web",
  },
  "pricing.chat.subtitle": {
    es: "Atiende clientes automáticamente, captura leads y agenda citas 24/7.",
    en: "Automatically serve customers, capture leads and book appointments 24/7.",
  },
  ...
  "pricing.universal.f1": {
    es: "Activación estándar en aproximadamente 48 horas",
    en: "Standard activation in approximately 48 hours",
  },
  "pricing.universal.f2": { es: "Sin contratos de permanencia", en: "No long-term contracts" },
  "pricing.universal.f3": {
    es: "Cancelación sin penalización",
    en: "Cancellation without penalty",
  },
  "pricing.universal.f4": {
    es: "Garantía de satisfacción de 14 días",
    en: "14-day satisfaction guarantee",
  },
  ...
  "pricing.customNote": {
    es: "Las integraciones personalizadas, migraciones de datos y configuraciones complejas pueden requerir más tiempo. El alcance y el plazo se confirman antes de iniciar el proyecto.",
    en: "Custom integrations, data migrations, and complex setups may require more time. Scope and timeline are confirmed before starting the project.",
  },
  ...
  "solution.titleAccent": {
    es: "antes, durante y después de tu equipo.",
    en: "before, during and after your team.",
  },
  "solution.subtitle": {
  ...
  "solution.b1.desc": {
    es: "Responde FAQs y captura leads mientras tu equipo aún no llegó.",
    en: "Answers FAQs and captures leads before your team arrives.",
  },
  "solution.b2.title": { es: "Durante", en: "During" },
  "solution.b2.desc": {
    es: "Filtra lo repetitivo para que tu gente atienda lo que importa.",
    en: "Filters the repetitive so your people handle what matters.",
  },
  "solution.b3.title": { es: "Después", en: "After" },
  "solution.b3.desc": {
    es: "Cuando cierran, QubeSight sigue atendiendo y agendando.",
    en: "When they clock out, QubeSight keeps answering and booking.",
  },
  ...
  "how.s1.desc": {
    es: "Canales, FAQs, horarios y cómo quieres escalar a humano.",
    en: "Channels, FAQs, hours and how you want to escalate to humans.",
  },
  "how.s2.title": { es: "Configuramos todo", en: "We set everything up" },
  "how.s2.desc": {
    es: "Sin conocimientos técnicos. Listo en ~48 horas.",
    en: "No technical skills. Live in ~48 hours.",
  },
  "how.s3.title": { es: "Tu equipo gana un copiloto", en: "Your team gains a copilot" },
  "how.s3.desc": {
    es: "Menos carga repetitiva. Más clientes atendidos. Tú intervienes cuando quieras.",
    en: "Less repetitive load. More customers served. You step in anytime.",
  },
  ...
  "products.assistant.desc": {
    es: "WhatsApp, Instagram, Messenger y web. FAQs, leads y agenda.",
    en: "WhatsApp, Instagram, Messenger and web. FAQs, leads and booking.",
  },
  "products.assistant.for": {
    es: "Ideal si te llegan muchos mensajes",
    en: "Best if you get lots of messages",
  },
  "products.voice.name": { es: "Voice Bot", en: "Voice Bot" },
  "products.voice.tag": { es: "Voz", en: "Voice" },
  "products.voice.desc": {
    es: "Llamadas 24/7: FAQs, agenda y cobertura fuera de horario.",
    en: "Calls 24/7: FAQs, booking and after-hours coverage.",
  },
  "products.voice.for": {
    es: "Ideal si pierdes llamadas o tu línea satura",
    en: "Best if you miss calls or the line saturates",
  },
  "products.suite.name": { es: "AI Suite", en: "AI Suite" },
  "products.suite.tag": { es: "Todo en uno", en: "All-in-one" },
  "products.suite.desc": {
    es: "Chatbot + Voice Bot en un solo sistema.",
    en: "Chatbot + Voice Bot in one system.",
  },
  "products.suite.for": {
    es: "Ideal si quieres cobertura completa",
    en: "Best if you want full coverage",
  },
  ...
  "products.selector.subtitle": {
    es: "Responde según tu negocio:",
    en: "Answer based on your business:",
  },
  "products.selector.q1": {
    es: "Principalmente mensajes (WhatsApp / redes)",
    en: "Mostly messages (WhatsApp / social)",
  },
  ...
  "social.s2.label": {
    ...
    en: "coverage while the team rests",
  },
  "social.s3.value": { es: "40%", en: "40%" },
  "social.s3.label": {
    es: "más leads atendidos en el primer mes*",
    en: "more leads handled in month one*",
  },
  "social.s4.value": { es: "48h", en: "48h" },
  "social.s4.label": { es: "para estar en producción", en: "to go live" },
  "social.note": {
    es: "*Resultados reportados por clientes en implementación típica.",
    en: "*Results reported by customers in typical rollouts.",
  },
  ...
  "integrations.titleAccent": {
    es: "las herramientas que ya usas.",
    en: "the tools you already use.",
  },
  ...
  "faq.a1": {
    es: "No. Configuramos todo por ti. Tú solo defines horarios, FAQs y cuándo escalar a humano.",
    en: "No. We set everything up for you. You just define hours, FAQs and when to escalate to a human.",
  },
  "faq.q2": { es: "¿La IA reemplaza a mi equipo?", en: "Does AI replace my team?" },
  "faq.a2": {
    es: "No. QubeSight automatiza tareas repetitivas para que tu equipo se enfoque en criterio, ventas y clientes importantes.",
    en: "No. QubeSight automates repetitive tasks so your team focuses on judgment, sales and important clients.",
  },
  "faq.q3": {
    es: "¿Qué pasa si el cliente hace una pregunta complicada?",
    en: "What if a customer asks something complex?",
  },
  "faq.a3": {
    es: "La IA escala a una persona de tu equipo con el contexto de la conversación. Tú decides las reglas de handoff.",
    en: "AI escalates to someone on your team with full conversation context. You set the handoff rules.",
  },
  "faq.q4": { es: "¿Puedo intervenir una conversación?", en: "Can I take over a conversation?" },
  "faq.a4": {
    es: "Sí. En cualquier momento puedes asumir el chat o la llamada. La IA cede el control al instante.",
    en: "Yes. You can take over chat or call anytime. AI hands control over instantly.",
  },
  "faq.q5": { es: "¿Cuánto tarda la implementación?", en: "How long does implementation take?" },
  "faq.a5": {
    es: "La mayoría de los negocios están activos en menos de 48 horas.",
    en: "Most businesses go live in under 48 hours.",
  },
  "faq.q6": { es: "¿Qué canales soporta?", en: "Which channels are supported?" },
  "faq.a6": {
    es: "WhatsApp, Instagram, Facebook Messenger, Web Chat y llamadas telefónicas (Voice Bot).",
    en: "WhatsApp, Instagram, Facebook Messenger, Web Chat and phone calls (Voice Bot).",
  },
  "faq.q7": { es: "¿Puedo cancelar cuando quiera?", en: "Can I cancel anytime?" },
  "faq.a7": {
    es: "Sí. Sin permanencia ni penalizaciones. También tienes garantía de 14 días.",
    en: "Yes. No lock-in or penalties. You also get a 14-day guarantee.",
  },
  "faq.group.chat": { es: "Chatbots IA (WhatsApp y web)", en: "AI Chatbots (WhatsApp & web)" },
  "faq.group.voice": {
    es: "Voice Bots IA (recepción telefónica)",
    en: "AI Voice Bots (phone reception)",
  },
  "faq.group.general": { es: "General", en: "General" },
  "faq.c1.q": {
    es: "¿Usa mi número de WhatsApp actual?",
    en: "Does it use my current WhatsApp number?",
  },
  "faq.c1.a": {
    es: "Sí. Conectamos tu número existente o te configuramos uno nuevo, según prefieras.",
    en: "Yes. We connect your existing number or set up a new one, whichever you prefer.",
  },
  "faq.c2.q": { es: "¿El chatbot responde como robot?", en: "Does the chatbot sound robotic?" },
  "faq.c2.a": {
    es: "No. Se entrena con tu catálogo, precios y tono de marca, y entiende notas de voz y mensajes con errores de escritura.",
    en: "No. It is trained on your catalog, prices and brand tone, and it understands voice notes and messages with typos.",
  },
  "faq.c3.q": {
    es: "¿Puede agendar citas y cobrar?",
    en: "Can it book appointments and take payments?",
  },
  "faq.c3.a": {
    es: "Agenda citas directo en tu calendario y envía enlaces de pago o de reserva dentro del mismo chat.",
    en: "It books appointments straight into your calendar and sends payment or booking links inside the same chat.",
  },
  "faq.c4.q": {
    es: "¿Qué pasa si supero los mensajes del plan?",
    en: "What if I exceed my plan messages?",
  },
  "faq.c4.a": {
    es: "No se corta el servicio: se cobra un excedente por mensaje y te avisamos antes de llegar al límite.",
    en: "Service never stops: an overage per message applies and we warn you before you hit the limit.",
  },
  "faq.v1.q": { es: "¿Se nota que es una voz de IA?", en: "Can callers tell it is an AI voice?" },
  "faq.v1.a": {
    es: "La voz es natural y con latencia baja. Además siempre se identifica como asistente si el cliente lo pregunta.",
    en: "The voice is natural with low latency. It also identifies itself as an assistant if the caller asks.",
  },
  "faq.v2.q": {
    es: "¿Contesta varias llamadas al mismo tiempo?",
    en: "Does it answer several calls at once?",
  },
  "faq.v2.a": {
    es: "Sí. Atiende llamadas simultáneas sin dejar a nadie en espera ni mandar a buzón.",
    en: "Yes. It handles simultaneous calls with no hold queues or voicemail.",
  },
  "faq.v3.q": {
    es: "¿Puede transferir la llamada a una persona?",
    en: "Can it transfer the call to a person?",
  },
  "faq.v3.a": {
    es: "Sí. Transfiere a tu equipo según tus reglas y, si nadie contesta, toma el mensaje y lo envía por WhatsApp.",
    en: "Yes. It transfers to your team by your rules and, if nobody answers, takes a message and sends it via WhatsApp.",
  },
  "faq.v4.q": {
    es: "¿Necesito cambiar mi central telefónica?",
    en: "Do I need to change my phone system?",
  },
  "faq.v4.a": {
    es: "No. Te damos un número nuevo o desviamos el actual; la instalación no toca tu operación.",
    en: "No. We give you a new number or forward your current one; setup does not disrupt your operation.",
  },
};
