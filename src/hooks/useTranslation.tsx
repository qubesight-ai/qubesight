...
export const translations: Translations = {
  ...
  'products.ops.name': { es: 'Ops', en: 'Ops' },
  'products.ops.tag': { es: 'Operaciones', en: 'Operations' },
  'products.ops.desc': { es: 'Alertas, tareas y cierres: menos admin manual para gerencia.', en: 'Alerts, tasks and closes: less manual admin for management.' },
  'products.ops.for': { es: 'Ideal si gestionas cobros y equipos', en: 'Best if you manage billing and teams' },
  ...
  'products.selector.q4': { es: 'Quiero todo: chat, voz y ops', en: 'I want it all: chat, voice and ops' },
  ...
  'products.compare.ops': { es: 'Ops internas', en: 'Internal ops' },
