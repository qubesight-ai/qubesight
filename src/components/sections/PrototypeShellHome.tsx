  ...
  return (
    <section id="hero" className="prototype-hero">
      ...
      <div className="prototype-eyebrow">
        ● {spanish ? "AGENTES IA PARA NEGOCIOS QUE CRECEN" : "AI AGENTS FOR GROWING BUSINESSES"}
      </div>
      <h1>
        {spanish ? "Tus clientes" : "Your customers"}
        <br />
        {spanish ? "no esperan." : "won’t wait."}
        <br />
        <em>{spanish ? "Tu IA tampoco debería." : "Your AI shouldn’t either."}</em>
      </h1>
      <div className="prototype-hero-bottom">
        ...
        <div>
          ...
          <a href="#contact" className="prototype-text-link">
            {spanish ? "Hablar con un experto" : "Talk to an expert"}{" "}
...
const PrototypeShellHome = () => {
  ...
  return (
    <div className="prototype-shell">
      ...
      <main>
        <PrototypeHero />
        <section className="prototype-statement">
          <span>[ 01 — EL PROBLEMA ]</span>
          <h2>
            La misma inteligencia que tu equipo necesita.
            <br />
            <em>Una experiencia que tus clientes merecen.</em>
          </h2>
          <p>
            QubeSight conserva todos tus canales, productos y flujos; el nuevo diseño simplemente
            les da una experiencia más clara y memorable.
          </p>
        </section>
        <CinematicStory />
